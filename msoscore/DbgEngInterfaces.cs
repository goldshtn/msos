...
{
    /// <summary>
    /// This ugly interface hack is here because we need SetOutputCallbacksWide to 
    /// accept a specific interface, and not just an arbitrary IntPtr. The rest of the
    /// interface is copied verbatim from ClrMD\Debugger\IDebugClient5.cs.
    /// </summary>
    [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown), Guid("e3acb9d7-7ec2-4f0c-a0da-e81e0cbbe628")]
    public interface msos_IDebugClient5 : IDebugClient4
    {
        /* IDebugClient */
        ...
        /// <summary>
        /// This is the only method that is changed in our version of the interface.
        /// We need the parameter to have a specific type and not just IntPtr.
        /// </summary>
        [PreserveSig]
