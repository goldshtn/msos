    ...
    class DesktopGCHeap : HeapBase
    {
        ...
        internal string GetStringContents(Address strAddr)
        {
            ...
            if (m_stringLength != null)
                length = (int)m_stringLength.GetValue(strAddr);
            ...
            Address data = 0;
            if (m_firstChar != null)
                data = m_firstChar.GetAddress(strAddr);
            else
    ...
    class DesktopException : ClrException
    {
        ...
        public override string Message
        {
            get
            {
                ...
                if (field != null)
                    return (string)field.GetValue(m_object);
        ...
        public override ClrException Inner
        {
            get
            {
                ...
                if (field == null)
                    return null;
                object inner = field.GetValue(m_object);
        ...
        public override int HResult
        {
            get
            {
                ...
                if (field != null)
                    return (int)field.GetValue(m_object);
